...
namespace LibraryManagementSystem {
    ...
    public partial class StorageDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public BooksRow AddBooksRow(int Id, string Book_Id, string Book_Name, string Author) {
            ...
            private void InitClass() {
                ...
                this.columnBook_Name.MaxLength = 1073741823;
...
namespace LibraryManagementSystem.StorageDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ([Book_Id] = @Original" +
                "_Book_Id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Id], [Book_Id], [Book_Name], [Author]) VALUES (@Id, @" +
                "Book_Id, @Book_Name, @Author);\r\nSELECT Id, Book_Id, Book_Name, Author FROM Books" +
                " WHERE (Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Book_Name", global::System.Data.SqlDbType.NText, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Book_Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [Id] = @Id, [Book_Id] = @Book_Id, [Book_Name] = @Book_Na" +
                "me, [Author] = @Author WHERE (([Id] = @Original_Id) AND ([Book_Id] = @Original_B" +
                "ook_Id));\r\nSELECT Id, Book_Id, Book_Name, Author FROM Books WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Book_Name", global::System.Data.SqlDbType.NText, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Book_Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibraryManagementSystem.Properties.Settings.Default.StorageConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Book_Id, Book_Name, Author FROM dbo.Books";
        ...
        public virtual int Fill(StorageDataSet.BooksDataTable dataTable) {
        ...
        public virtual StorageDataSet.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StorageDataSet.BooksDataTable dataTable = new StorageDataSet.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StorageDataSet.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Book_Id) {
        ...
        public virtual int Insert(int Id, string Book_Id, string Book_Name, string Author) {
        ...
        public virtual int Update(int Id, string Book_Id, string Book_Name, string Author, int Original_Id, string Original_Book_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Book_Id, string Book_Name, string Author, int Original_Id, string Original_Book_Id) {
            return this.Update(Original_Id, Book_Id, Book_Name, Author, Original_Id, Original_Book_Id);
        }
    }
